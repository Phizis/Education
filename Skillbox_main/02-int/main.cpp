...
int main() {
    ...
    std::cout << "Эта программа рассчитает, сколько клиентов успеет обслужить кассир за смену.\nВведите длительность смены в минутах: " << workShift << "\nСколько минут клиент делает заказ? " << orderTime << "\nСколько минут кассир собирает заказ? " << cashierTime << "\n-----Считаем-----\nЗа смену длиной " << workShift << " минут кассир успеет обслужить " << clientsShift << " клиентов\n" ;
